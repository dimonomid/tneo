...
It is still under development, but all the public system services are already documented. Documentation is generated by means of [doxygen](http://goo.gl/RQHRYr).
